...
const CORE_NAV = [
  ...
  { label: "Desks", href: "/desks", icon: LayoutGrid },
  { label: "News Sources & Wire", href: "/news-sources", icon: Rss },
  { label: "News Reader / Inbox", href: "/news-reader", icon: BookOpen },
];

const PLATFORM_NAV = [
  { label: "User Management", href: "/users", icon: Users },
  { label: "Roles & RBAC Matrix", href: "/roles", icon: ShieldAlert },
  { label: "System Audit Logs", href: "/audit", icon: FileCode2 },
  { label: "Feature Flags", href: "/flags", icon: Flag },
  { label: "API Keys & Secrets", href: "/api-keys", icon: KeyRound },
  { label: "Infrastructure Health", href: "/health", icon: Activity },
  { label: "Scheduled Jobs", href: "/jobs", icon: Clock },
];
      ...
      >
        ...
        <div className="h-16 px-5 flex items-center justify-between border-b border-slate-100 shrink-0">
          <Link href="/" className="block">
            ...
            <span className="text-[10px] text-slate-400 uppercase font-mono font-bold tracking-wider block mt-0.5">
              Admin Console
            </span>
          </Link>
        </div>
