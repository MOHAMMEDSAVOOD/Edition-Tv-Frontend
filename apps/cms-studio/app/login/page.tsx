...
export default function CmsLoginPage() {
  ...
  const presets = [
    { label: "Editor Director", user: "editor", pass: "EditionPass2026!", role: "EDITORIAL DIRECTOR" },
    { label: "Senior Journalist", user: "journalist", pass: "EditionPass2026!", role: "NEWS CORRESPONDENT" },
  ];
        ...
        <div className="lg:w-1/2 xl:w-7/12 bg-slate-100/90 p-8 lg:p-16 flex flex-col justify-between relative overflow-hidden border-b lg:border-b-0 lg:border-r border-slate-200">
          ...
          <div className="relative z-10">
            <div className="inline-flex items-center gap-2 bg-red-50 border border-red-200 text-red-700 font-mono text-xs px-3.5 py-1.5 rounded-full shadow-xs">
              ...
              <span className="font-bold tracking-wide">PARTNER EDITORIAL PORTAL &bull; partner.editiontv.com</span>
            </div>
          </div>
          ...
          <div className="relative z-10 my-auto py-8 space-y-6 max-w-2xl">
            <div className="space-y-3">
              <h1 className="text-3xl lg:text-5xl font-extrabold text-slate-900 tracking-tight font-serif leading-tight">
                Set Your Editorial Newsroom on <span className="text-red-600 underline decoration-red-300 decoration-4 underline-offset-4">Auto-Pilot</span>
              </h1>
              <p className="text-slate-600 text-base leading-relaxed">
                Real-time story composition, multi-desk editorial review, RSS wire ingestion, fact-check verification, and direct web publishing.
              </p>
            </div>
            ...
            <div className="relative rounded-3xl overflow-hidden border border-slate-200 shadow-2xl bg-white group">
              ...
              <div className="absolute bottom-4 left-4 bg-white/95 backdrop-blur-md px-4 py-2.5 rounded-2xl shadow-lg border border-slate-100 flex items-center gap-3">
                <div className="h-9 w-9 rounded-xl bg-red-500/10 text-red-600 flex items-center justify-center font-bold">
                  <Newspaper className="h-5 w-5" />
                </div>
                <div>
                  <span className="text-xs text-slate-500 font-mono block">Published Stories</span>
                  <span className="text-sm font-extrabold text-slate-900 font-mono">38 Live Stories</span>
                </div>
              </div>
              ...
              <div className="absolute top-4 right-4 bg-slate-900/90 text-white backdrop-blur-md px-3.5 py-2 rounded-xl shadow-lg border border-slate-800 flex items-center gap-2 font-mono text-xs">
                ...
                <span>Wire Ingestion: Operational</span>
              </div>
            </div>
          </div>
          ...
          <div className="relative z-10 text-xs text-slate-500 font-mono flex items-center justify-between pt-4 border-t border-slate-200/80">
            <span>Multi-Desk Editorial Workflow</span>
            <span>Rich Block Editor &bull; Spring Security JWT</span>
          </div>
        </div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <span className="text-[10px] font-mono font-bold text-slate-400 uppercase tracking-wider">CMS Studio</span>
              </div>
            </div>
          </div>
          ...
          <div className="my-auto py-6 space-y-6 max-w-md w-full mx-auto">
            ...
            <div className="space-y-1">
              ...
              <p className="text-sm text-slate-500 font-sans">
                Login to your account. Select your editorial role to access the story composition workspace.
              </p>
            </div>

            {/* Quick Editorial Role Selection */}
            <div>
              <label className="text-[11px] font-mono uppercase tracking-wider text-slate-500 block mb-2 font-bold">
                Select Editorial Role:
              </label>
              <div className="grid grid-cols-1 gap-2.5">
                {presets.map((p) => (
                  ...
                  >
                    <div className="flex items-center gap-2.5">
                      <Feather className="h-4 w-4 text-red-600" />
                      <div>
            ...
            {success && (
              <div className="bg-emerald-50 border border-emerald-200 text-emerald-800 p-3.5 rounded-xl text-xs flex items-center gap-2 font-mono">
                ...
                <span>Authentication successful! Accessing CMS Studio...</span>
              </div>
            )}
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="editor or journalist"
