      ...
      <div className="w-full flex flex-col lg:flex-row min-h-screen">
        ...
        <div className="lg:w-1/2 xl:w-7/12 bg-slate-100/90 p-8 lg:p-16 flex flex-col justify-between relative overflow-hidden border-b lg:border-b-0 lg:border-r border-slate-200">
          ...
          <div className="relative z-10 text-xs text-slate-500 font-mono flex items-center justify-between pt-4 border-t border-slate-200/80">
            ...
            <span>Rich Block Editor &bull; Firebase Authentication</span>
          </div>
        </div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <span className="text-[10px] font-mono font-bold text-slate-400 uppercase tracking-wider">Partner Portal</span>
              </div>
            </div>
          </div>
          ...
          <div className="my-auto py-6 space-y-6 max-w-md w-full mx-auto">
            ...
            <div className="space-y-1">
              ...
              <p className="text-sm text-slate-500 font-sans">
                Login to your account. Enter your editorial credentials to access the story composition workspace.
              </p>
            </div>
            ...
            {success && (
              <div className="bg-emerald-50 border border-emerald-200 text-emerald-800 p-3.5 rounded-xl text-xs flex items-center gap-2 font-mono">
                ...
                <span>Authentication successful! Accessing Partner Portal...</span>
              </div>
            )}
            ...
            <form onSubmit={handleSubmit} className="space-y-4" autoComplete="on">
              <div>
                <label htmlFor="edition_cms_email" className="text-xs font-semibold text-slate-700 block mb-1.5">
                  Editorial Email
                </label>
                <div className="relative">
                  ...
                  <input
                    type="email"
                    name="email"
                    id="edition_cms_email"
                    autoComplete="email"
                    required
                    value={email}
                    onChange={(e) => setEmail(e.target.value)}
                    placeholder="editor@editiontv.com"
              ...
              <div>
                <label htmlFor="edition_cms_pass" className="text-xs font-semibold text-slate-700 block mb-1.5">
                  Password
                </label>
                <div className="relative">
