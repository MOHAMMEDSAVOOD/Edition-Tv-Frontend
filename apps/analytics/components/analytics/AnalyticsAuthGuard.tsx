...
import { AnalyticsTopNav } from "@/components/layout/AnalyticsTopNav";

export function AnalyticsAuthGuard({ children }: { children: React.ReactNode }) {
    ...
    return (
      <div className="h-screen w-screen bg-slate-950 text-slate-100 flex items-center justify-center font-sans text-sm">
        <div className="flex items-center gap-3">
          ...
          <span>Verifying Analytics Telemetry Key...</span>
        </div>
      </div>
    );
  }
